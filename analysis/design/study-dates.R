...
study_dates <- tibble::lst(
  studystart_date = "2020-01-01", # first possible study entry date (start of pandemic in UK), and index date for dates as "time since index date" format
  studyend_date = "2022-04-01", # last study entry dates
